  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-0.5 text-muted-foreground group-data-horizontal/tabs:h-12 md:group-data-horizontal/tabs:h-10 group-data-vertical/tabs:h-fit md:group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col",
  {
    variants: {
      variant: {
        ...
        browser: "rounded-none p-0 border-b border-border gap-1 items-end bg-transparent w-full justify-start group-data-horizontal/tabs:h-auto md:group-data-horizontal/tabs:h-auto",
      },
    },
    defaultVariants: {
      variant: "default",
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("flex-1 text-sm outline-none group-has-[[data-variant=browser]]/tabs:bg-background group-has-[[data-variant=browser]]/tabs:border-t-transparent group-has-[[data-variant=browser]]/tabs:rounded-tr-none", className)}
      {...props}
    />
  )
}
